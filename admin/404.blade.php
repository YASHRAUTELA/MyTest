...
<!-- css files -->
<link href="{{asset('css/error/style.css')}}" rel="stylesheet" type="text/css" media="all">
<!-- //css files -->
...
<body style="background:url('../images/error/b1.jpg')">
<div class="header">
...
<div class="w3-main">
	<div class="agile-info">
		...
		<h2>4<img src="{{asset('images/error/confused.gif')}}" alt="image">4</h2>
		<p>An error Occurred in the Application And Your Page could not be Served.</p>
		
		<a href="{{route('default')}}">go back</a>
	</div>
</div>
</body>
</html>