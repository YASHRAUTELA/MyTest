	        ...
	        <div class="modal-body">
	        	...
	        	<div class="row">
	        		<div class="col-md-2">
	        			<div class="row">
	        				<div class="col-md-12">
	        					<label>To: </label>&nbsp;&nbsp;<span id="receiver_name"></span><br>	
	 ...
	 function sentMail(mail_id){
	 	...
	 	$.ajax({
            ...
            success: function(data) {
            	...
            	$("#image").html("<img style='height:50px; width:50px;' src={{asset('images')}}"+'/'+data[0].image_title+">");
            	$("#receiver_name").text(data[0].name);
